...
//Función principal del mes de Febrero:
...
void opcionmenu2(struct Taguas vector[], int i) {
	...
	printf("La fuente con más coliformes es la %s con un valor de %d\n", vector[masColi].nombreFuente, vector[masColi].coliformes);
